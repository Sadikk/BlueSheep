...
namespace BlueSheep.Engine.ExceptionHandler
{
        ...
        private static string StackFrameToString(StackFrame sf)
	{
		...
		foreach (ParameterInfo Parameter in objParameters) {
			...
			if (intParam > 1)
				_with1.Append(", ");
			_with1.Append(Parameter.Name);
			_with1.Append(" As ");
			_with1.Append(Parameter.ParameterType.Name);
		}
		_with1.Append(")");
        ...
        private static string FormatExceptionForUser(bool blnConsoleApp)
        {
            ...
            if (_blnLogToEmail)
            {
                ...
                _with2.Append(Environment.NewLine);
                _with2.Append("   ");
                _with2.Append("errorsheep@gmail.com");
                _with2.Append(Environment.NewLine);
            }
            _with2.Append(Environment.NewLine);
            _with2.Append(Environment.NewLine);
        ...
        private static void ExceptionToFile()
        {
            ...
            try
            {
                StreamWriter objStreamWriter = new StreamWriter(_strLogFullPath, true);
        ...
        private static void ThreadHandler()
        {
            ...
            //_with3.To = "errorsheep@gmail.com";
